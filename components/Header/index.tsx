    ...
    return (
        <div className="w-full p-4 rounded-xl grid grid-cols-3 md:grid-cols-5 lg:grid-cols-3 gap-12">
            <div className="hidden md:flex col-span-3 md:col-span-5 lg:col-span-3 my-4 rounded-md border-2 border-gray-200 px-4 py-2 text-sm w-max mx-auto ...">
                <span className="py-1 px-2 rounded-md bg-yellow-50 text-yellow-500 font-bold">
            ...
            <div className="col-span-3 md:col-span-3 lg:col-span-2 flex flex-col space-y-2">
                ...
                <div className="py-4">
                    <a href="#" className="underline font-bold text-yellow-500">
                ...
                <div className="py-1">
                    <p className="text-sm">
                        ...
                        <a className="text-yellow-500 underline" href="https://blitzjs.com/" target="_blank"> Blitzjs</a>.
                        Please check it out :)
                    </p>
                </div>
                <div className="py-8">
